...
class AgentManager:
    def __init__(self):
        ...
        self.llm: OpenAI | Ollama | None = None
    ...
    async def initialize(self, model: str = settings.model, system_prompt: str | None = None) -> None:
        ...
        if system_prompt is None:
            system_prompt = (
                "You are an AI assistant to help the user as best as you can. "
...
async def get_agent(system_prompt: str) -> FunctionAgent | Any:
    if not agent_manager.is_initialized():
        await agent_manager.initialize()
